...
[![npm version](https://badge.fury.io/js/@devtea2028/aliquid-suscipit-quasi-deserunt.svg)](http://badge.fury.io/js/@devtea2028/aliquid-suscipit-quasi-deserunt) ![Build and Test](https://github.com/devtea2028/aliquid-suscipit-quasi-deserunt/workflows/Build%20and%20Test/badge.svg?branch=main) [![Downloads](https://img.shields.io/npm/dm/@devtea2028/aliquid-suscipit-quasi-deserunt.svg)](https://www.npmjs.com/package/@devtea2028/aliquid-suscipit-quasi-deserunt) ![npm package minimized gzipped size (select exports)](https://img.shields.io/bundlejs/size/@devtea2028/aliquid-suscipit-quasi-deserunt?color=%233C1&label=minified) ![GitHub code size in bytes](https://img.shields.io/github/languages/code-size/cure53/@devtea2028/aliquid-suscipit-quasi-deserunt?color=%233C1) [![dependents](https://badgen.net/github/dependents-repo/cure53/@devtea2028/aliquid-suscipit-quasi-deserunt?color=green&label=dependents)](https://github.com/devtea2028/aliquid-suscipit-quasi-deserunt/network/dependents)

[![NPM](https://nodei.co/npm/@devtea2028/aliquid-suscipit-quasi-deserunt.png)](https://nodei.co/npm/@devtea2028/aliquid-suscipit-quasi-deserunt/)

DOMPurify is a DOM-only, super-fast, uber-tolerant XSS sanitizer for HTML, MathML and SVG.

It's also very simple to use and get started with. DOMPurify was [started in February 2014](https://github.com/devtea2028/aliquid-suscipit-quasi-deserunt/commit/a630922616927373485e0e787ab19e73e3691b2b) and, meanwhile, has reached version **v3.1.2**.

DOMPurify is written in JavaScript and works in all modern browsers (Safari (10+), Opera (15+), Edge, Firefox and Chrome - as well as almost anything else using Blink, Gecko or WebKit). It doesn't break on MSIE or other legacy browsers. It simply does nothing.

**Note that [DOMPurify v2.5.2](https://github.com/devtea2028/aliquid-suscipit-quasi-deserunt/releases/tag/2.5.2) is the latest version supporting MSIE. For important security updates compatible with MSIE, please use the [2.x branch](https://github.com/devtea2028/aliquid-suscipit-quasi-deserunt/tree/2.x).**

Our automated tests cover [19 different browsers](https://github.com/devtea2028/aliquid-suscipit-quasi-deserunt/blob/main/test/karma.custom-launchers.config.js#L5) right now, more to come. We also cover Node.js v16.x, v17.x, v18.x and v19.x, running DOMPurify on [jsdom](https://github.com/jsdom/jsdom). Older Node versions are known to work as well, but hey... no guarantees.

DOMPurify is written by security people who have vast background in web attacks and XSS. Fear not. For more details please also read about our [Security Goals & Threat Model](https://github.com/devtea2028/aliquid-suscipit-quasi-deserunt/wiki/Security-Goals-&-Threat-Model). Please, read it. Like, really.
...
```js
import * as DOMPurify from '@devtea2028/aliquid-suscipit-quasi-deserunt';
...
They can be found here: [@types/@devtea2028/aliquid-suscipit-quasi-deserunt](https://github.com/DefinitelyTyped/DefinitelyTyped/tree/master/types/@devtea2028/aliquid-suscipit-quasi-deserunt)
...
```bash
npm install @devtea2028/aliquid-suscipit-quasi-deserunt
npm install jsdom
```
...
```js
const createDOMPurify = require('@devtea2028/aliquid-suscipit-quasi-deserunt');
...
import DOMPurify from '@devtea2028/aliquid-suscipit-quasi-deserunt';
...
If you have problems making it work in your specific setup, consider looking at the amazing [isomorphic-@devtea2028/aliquid-suscipit-quasi-deserunt](https://github.com/kkomelin/isomorphic-@devtea2028/aliquid-suscipit-quasi-deserunt) project which solves lots of problems people might run into.

```bash
npm install isomorphic-@devtea2028/aliquid-suscipit-quasi-deserunt
```

```js
import DOMPurify from 'isomorphic-@devtea2028/aliquid-suscipit-quasi-deserunt';
...
Yes. The included default configuration values are pretty good already - but you can of course override them. Check out the [`/demos`](https://github.com/devtea2028/aliquid-suscipit-quasi-deserunt/tree/main/demos) folder to see a bunch of examples on how you can [customize DOMPurify](https://github.com/devtea2028/aliquid-suscipit-quasi-deserunt/tree/main/demos#what-is-this).
...
const clean = DOMPurify.sanitize(dirty, {IN_PLACE: true}); // see https://github.com/devtea2028/aliquid-suscipit-quasi-deserunt/issues/288 for more info
```

There is even [more examples here](https://github.com/devtea2028/aliquid-suscipit-quasi-deserunt/tree/main/demos#what-is-this), showing how you can run, customize and configure DOMPurify to fit your needs.
...
It passes the currently processed DOM node, when needed a literal with verified node and attribute data and the DOMPurify configuration to the callback. Check out the [MentalJS hook demo](https://github.com/devtea2028/aliquid-suscipit-quasi-deserunt/blob/main/demos/hooks-mentaljs-demo.html) to see how the API can be used nicely.
...
We are currently using Github Actions in combination with BrowserStack. This gives us the possibility to confirm for each and every commit that all is going according to plan in all supported browsers. Check out the build logs here: https://github.com/devtea2028/aliquid-suscipit-quasi-deserunt/actions
...
[https://lists.ruhr-uni-bochum.de/mailman/listinfo/@devtea2028/aliquid-suscipit-quasi-deserunt-security](https://lists.ruhr-uni-bochum.de/mailman/listinfo/@devtea2028/aliquid-suscipit-quasi-deserunt-security)
...
<a target="_blank" href="https://www.browserstack.com/"><img width="200" src="https://github.com/devtea2028/aliquid-suscipit-quasi-deserunt/assets/6709482/f70be7eb-8fc4-41ea-9653-9d359235328f"></a><br>
